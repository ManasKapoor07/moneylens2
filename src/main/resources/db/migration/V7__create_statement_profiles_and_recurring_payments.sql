...
CREATE UNIQUE INDEX IF NOT EXISTS idx_profile_user_month
    ON statement_profiles (user_id, profile_year, profile_month);

CREATE INDEX IF NOT EXISTS idx_profile_statement
...
CREATE INDEX IF NOT EXISTS idx_recurring_profile
    ON recurring_payments (statement_profile_id);

CREATE INDEX IF NOT EXISTS idx_recurring_merchant
    ON recurring_payments (user_id, merchant_key);